...
import {Modifiers, EQUIPPED_WEARABLE_SLOTS, Pyraniha} from "../libraries/LibAppStorage.sol";
...
contract ItemsTransferFacet is Modifiers {
    ...
    */
    ...
    function transferFromTokenApproved(
        ...
        if (_fromContract == address(this)) {
            address owner = s.pyranihas[_fromTokenId].owner;
            require(
            ...
            require(s.pyranihas[_fromTokenId].locked == false, "ItemsTransfer: Only callable on unlocked Pyranihas");
        } else {
    ...
    */
    ...
    function extractItemsFromSacrificedGotchi(
        ...
        require(pyraniha.owner == address(0), "Pyraniha has not been sacrificed");
